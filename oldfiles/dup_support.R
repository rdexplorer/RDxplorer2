...
#pr_file="LP6005162-DNA_B01.rdxp.chr2.pr_dup.new";
#id_file="LP6005162-DNA_B01.rdxp.chr2.id_dup";
#ref_file="LP6005162-DNA_B01.rdxp.background_distribution.csv";
#out_file="LP6005162-DNA_B01.rdxp.chr2.id_dup.csv";
#chr="chr1";
...
valid.pair.dup <- distances.dup[,3] > 200 & distances.dup[,7] > 200 
...
Result<-1;
Result<-cbind(dup.events,dup.neg,dup.g1000,readcount.off.max,dup.off.chr,readcount.off.total);
Result<-cbind(chrom,dup.events,Result,dup.pass);
